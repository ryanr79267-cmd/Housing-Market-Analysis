...
/************************************************************************************************************************
		1.	Create procedure parameters for a summary or detailed report, the desired year, month, state, and property type
	************************************************************************************************************************/

CREATE PROC [dbo].[usp_CEN_HomesSoldByPropertyType_Show]
...
/************************************************************************************************************************
		2.	Retrieve Homes_sold, price columns, listing columns, inventory columns, median_dom(days on market), and period_begin
		to track trends overtime. Use region, city, state, and property type to filter for select areas and types.
	************************************************************************************************************************/
	...
	/************************************************************************************************************************
		3.	Fitler for year and or property type if entered, else show all of either one.
	************************************************************************************************************************/
	...
	/************************************************************************************************************************
		4.	If report_type is set to summary, then a summarized report will be created as a pivot table for faster processing.
		The table will display selected property types, years, and state.
	************************************************************************************************************************/
	...
	/************************************************************************************************************************
		5.	If report_type is set to detail, then a detailed report will be created for more in-depth results. It will display
		all columns and will filter based on state and month if entered, otherwise all data will be shown.
	************************************************************************************************************************/
